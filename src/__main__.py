...
endgames = [
    "8/8/4n1k1/6pp/1P1p4/1K6/8/3R4 w KQkq - 0 1",
    "8/8/4n1k1/6pp/1P1B4/1K6/8/3R4 w KQkq - 0 1",
    "8/1k6/6RR/8/8/8/5K2/8 w KQkq - 0 1",
    "8/1k4p1/4p2p/8/5p2/8/5K2/8 w KQkq - 0 1",
    "3r4/1k1r4/8/8/8/3Q4/8/2K2R2 w KQkq - 0 1",
    "3r4/1k1r1ppp/8/8/8/3Q4/8/2K2R2 w KQkq - 0 1",
    "3rr3/1k3p2/8/8/8/8/4p3/1KR1R3 w KQkq - 0 1",
    "8/5p2/4n1k1/6pp/1P1n4/1K6/8/3R4 w KQkq - 0 1",
    "8/5p2/8/6pp/1P1nk3/1K6/8/3R4 w KQkq - 0 1",
    "8/8/4n1k1/6pp/1P1p4/1K6/1B6/8 w KQkq - 0 1",
    "8/8/3p2k1/2p3pp/3B4/1K6/8/8 w KQkq - 0 1",
    "8/8/3p2k1/4p1pp/3B4/1K6/8/8 w KQkq - 0 1",
    "3k4/7Q/4K3/8/8/8/8/8 w KQkq - 0 1",
    "3k4/7Q/4K3/8/8/3b4/2p5/8 w KQkq - 0 1",
    "2rk4/7Q/4K3/8/8/2p5/8/8 w KQkq - 0 1",
    "1k6/ppp5/8/8/8/8/PP3P2/3K4 w KQkq - 0 1",
    "r2k4/8/8/8/1r2K3/8/8/8 w KQkq - 0 1",
    "rk6/8/8/8/8/1r6/4K3/8 w KQkq - 0 1",
    "rk6/8/8/4K3/8/1r6/8/8 w KQkq - 0 1",
    "8/6P1/8/3q4/2P5/3P4/4P1k1/3K4 b KQkq - 0 1",
    "8/ppp5/3k4/8/3P4/8/PPP5/1K6 w KQkq - 0 1",
    "8/1k6/6p1/7P/2b1n3/8/1P1PP1P1/1K6 w KQkq - 0 1",
    "1r6/1k4b1/6p1/7P/3N4/8/8/1K5R w KQkq - 0 1",
    "1r6/bk6/6p1/7P/3N4/8/8/1K5R w KQkq - 0 1",
    "3r4/1k6/6p1/7P/3N4/8/8/1K5R w KQkq - 0 1",
    ...
    "6kr/8/4n3/8/R2P4/2P5/5K2/8 w - - 0 1",
...
def get_training_loop():
    model_paths = glob.glob("models/policy_gradients/*.ckpt")
    model_paths.sort()

    if model_paths == []:
        return TrainingLoop(ChessPolicy(15), 50)

    return torch.load(model_paths[-1], weights_only=False)
